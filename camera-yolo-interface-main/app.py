# app.py - Fixed AI Waste Sorter with Correct Angle Calculations
...
class CameraRobotCalibrator:
    ...
    def get_robot_angles_for_pixel(self, pixel_x: float, pixel_y: float):
        ...
        print(f"🤖 Angles: Base={base_angle:.0f}°, Shoulder={shoulder_angle:.0f}°, Elbow={elbow_angle:.0f}°, WristP={wrist_pitch:.0f}°")
...
# HTML Interface (same as before - keep the full HTML from previous response)
@app.get("/", response_class=HTMLResponse)
async def index(request: Request):
    # [Keep the exact same HTML content from the previous response]
    # This includes all the JavaScript for click handling, UI updates, etc.
    ...
    <head>
      ...
      <title>AI Waste Sorter with Camera Calibration</title>
    ...
    <body>
      <div class="container-fluid p-3" style="height: 100vh; overflow: hidden;">
        <div class="d-flex justify-content-between align-items-center mb-3 border-bottom pb-2">
          <h3>🤖 AI Waste Sorter with Camera Calibration</h3>
      ...
      <script>
        // [Keep the exact same JavaScript from previous response]
        // This handles all the click events, API calls, and UI updates
...
if __name__ == '__main__':
    ...
    print("🚀 Starting AI Waste Sorter with FIXED Angle Calculations at http://localhost:8000")
